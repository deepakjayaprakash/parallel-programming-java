...
public class ReciprocalArraySum {
    ...
    static int THRESHOLD; // control when you want to fork
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        for (int i = 0; i< numTasks; i++) {
            ...
            forkJoinPool.invoke(reciprocalArraySumTask);
            totalSum += reciprocalArraySumTask.value;
        }
        return totalSum;
    }
}
